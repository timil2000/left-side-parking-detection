 parse_opt():
    ...
    parser.add_r.add_argument('--save-crop', action='store_true', help='save cropped prediction boxes')
...
defment('--line-thickness', default=3, type=int, help='bounding box thickness (pixels)')
