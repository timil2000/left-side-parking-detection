...
from trackbleobject import TrackbleObject
...
@torch.no_grad()
# def detect(weights=r'C:\Users\Vivek Parekh\Desktop\yolov5-object-tracking\yolov5s.pt',
#            source=r'C:\Users\Vivek Parekh\Desktop\yolov5-object-tracking\newcutvideo1.mp4',
#         data=r'C:\Users\Vivek Parekh\Desktop\yolov5-object-tracking\data\coco128.yaml',
...
#         project=r'C:\Users\Vivek Parekh\Desktop\yolov5-object-tracking\runs\detect',  name='exp',
...
def detect(weights=r'C:\pythonworkspace\yolov5-object-tracking-main\yolov5s.pt',
           source=r'C:\pythonworkspace\yolov5-object-tracking-main\detect.avi',
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                if len(tracked_dets)>0:
                    ...
                    for cord in tracked_dets:
                        ...
                        if to is None:
                            to = TrackbleObject(cord[8], (x_c, y_c))
                            print("TOOOO", to)
                        else:
                            ...
                            if not to.counted:
                                idx = int(cord[4])
                                print("idx", type(idx))
                                if direction > 0 and height // 4.7 < y_c < height // 4.0:
                                    if (idx == 2):
                                        totalDownCar1 += 1
                                        to.counted = True
                                    elif (idx == 3 or idx == 1):
                                        ...
                                        totalDownTruck1 += 1
                                        to.counted = True
                                elif direction > 0 and height // 1.9 < y_c < height // 1.7:
                                    if (idx == 2):
                                        totalDownCar += 1
                                        to.counted = True
                                    elif (idx == 3 or idx == 1):
            ...
            start_point_upper = (0, int(height // 4.7))
            start_point = (0, int(height // 4.0))
            start_point_middle = (0, int(height // 1.9))
            start_point_below = (0, int(height // 1.7))

            end_point_upper = (int(im0.shape[1]), int(height // 4.7))
            end_point = (int(im0.shape[1]), int(height // 4.0))
            end_point_middle = (int(im0.shape[1]), int(height // 1.9))
            end_point_below = (int(im0.shape[1]), int(height // 1.7))
